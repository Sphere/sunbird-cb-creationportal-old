export enum Notify {
  ...
  CONTENT_SELF_ASSESSMENT_SUCCESS = 'CONTENT_SELF_ASSESSMENT_SUCCESS',
  NOT_READY = 'NOT_READY',
  ...
  ENTER_DURATION_FIELD = 'ENTER_DURATION_FIELD',
  DURATION_CANT_BE_0 = 'DURATION_CANT_BE_0',
  LINK_IS_INVALID = 'LINK_IS_INVALID',
  REQUIRED_FIELD = 'REQUIRED_FIELD',
  INVALID_RESOURCE_NAME = 'INVALID_RESOURCE_NAME',
  INVALID_MODULE_NAME = 'INVALID_MODULE_NAME',
  INVALID_COURSE_NAME = 'INVALID_COURSE_NAME',
  INVALID_COMPETENCY = 'INVALID_COMPETENCY',
  SELF_ASSESSMENT_COMPETENCY = 'SELF_ASSESSMENT_COMPETENCY',
  REMOVE_SELF_ASSESSMENT_COMPETENCY = 'REMOVE_SELF_ASSESSMENT_COMPETENCY',
  UPLOAD_FILE_REMOVED = 'UPLOAD_FILE_REMOVED',
  UPLOAD_FILE_ERROR = 'UPLOAD_FILE_ERROR',
  DURATION_CANT_BE_GREATER = 'DURATION_CANT_BE_GREATER',
  INVALID_QUESTION = 'INVALID_QUESTION',
  INVALID_OPTION = 'INVALID_OPTION',
  INVALID_IS_CORRECT = 'INVALID_IS_CORRECT',
  INVALID_MIN_OPTION = 'INVALID_MIN_OPTION',
  INVALID_ANSWER_INFO = 'INVALID_ANSWER_INFO',
  QUESTION_DURATION_CANT_BE_0 = 'QUESTION_DURATION_CANT_BE_0',
