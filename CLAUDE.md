...
- **Version:** 0.0.1 — **Angular 21** (migrated from Angular 8; see §8).
...
*Keep this file in sync when the stack, standards, or deploy layout change. It is the shared source of truth for AI-assisted work on this repo.*
